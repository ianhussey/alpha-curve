...
data_estimates <- data_extracted |>
  mutate(
    ...
    exclude_cutoff_present = str_detect(all, "cut(\\s|-)off|criteria|is considered|is generally considered|threshold"),
    exclude_range_present = str_detect(substring_between_cronbach_and_estimate, "(range|ranging|between|from)"),
    exclude_range_present_2 = str_detect(all, "(.70s|.80s|.90s)"),
