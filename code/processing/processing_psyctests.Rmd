...
alpha <- "(cronbach('|’)?s?|\\balpha(s)?\\b|\\bα(s)?\\s*|\\ba(s)?\\s*)"

str_detect("alpha was ", alpha)
str_detect("internal consistency was a ", alpha)
str_detect("internal consistency were  as = ", alpha)
str_detect("internal consistency was ", alpha)
str_detect("alphas where ", alpha)
