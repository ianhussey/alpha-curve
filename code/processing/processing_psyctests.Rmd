...
data_processed <- data_estimates_after_exclusions |>
  ...
  select(doi, test_type, exemplar, alpha, alpha_all,
         extracted_text = all, regex_label, regex_inclusion, regex_exclusion, alpha_location_in_text = location_alpha_absolute, 
         starts_with("exclude"))
