...
data_processed_trt <- data_extracted_trt |>
  mutate(
    # locations
...
write_csv(data_processed_trt, "../../data/processed/data_processed_trt.csv")
#data_processed_trt <- read_csv("../../data/processed/data_processed_trt.csv")
