...
Because this script has to load a very large number of files (75k), runtime is slow. 3+ hours for the extract strings chunk, around 1 hour for combining the csv files.
