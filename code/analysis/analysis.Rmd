...
proportion_with_valid_alpha <- 
  janitor::round_half_up(pull(n_estimates_after_exclusions, n_estimates) / n_doi, 2)
...
- There were `r data_inflation_kernel$inflation_for_reporting[data_inflation_kernel$alpha == 0.69]`% fewer observations of Cronbach's $a$ = .69 and `r data_inflation_kernel$inflation_for_reporting[data_inflation_kernel$alpha == 0.70]`% more observations of Cronbach's $a$ = .70 than predicted.
- There were `r data_inflation_kernel$inflation_for_reporting[data_inflation_kernel$alpha == 0.79]`% fewer observations of Cronbach's $a$ = .79 and `r data_inflation_kernel$inflation_for_reporting[data_inflation_kernel$alpha == 0.80]`% more observations of Cronbach's $a$ = .80 than predicted.
- There were `r data_inflation_kernel$inflation_for_reporting[data_inflation_kernel$alpha == 0.89]`% more observations of Cronbach's $a$ = .89 and `r data_inflation_kernel$inflation_for_reporting[data_inflation_kernel$alpha == 0.90]`% more observations of Cronbach's $a$ = .90 than predicted.
...
- There were `r data_inflation_beta$inflation_for_reporting[data_inflation_kernel$alpha == 0.69]`% fewer observations of Cronbach's $a$ = .69 and `r data_inflation_beta$inflation_for_reporting[data_inflation_kernel$alpha == 0.70]`% more observations of Cronbach's $a$ = .70 than predicted.
- There were `r data_inflation_beta$inflation_for_reporting[data_inflation_kernel$alpha == 0.79]`% fewer observations of Cronbach's $a$ = .79 and `r data_inflation_beta$inflation_for_reporting[data_inflation_kernel$alpha == 0.80]`% more observations of Cronbach's $a$ = .80 than predicted.
- There were `r data_inflation_beta$inflation_for_reporting[data_inflation_kernel$alpha == 0.89]`% more observations of Cronbach's $a$ = .89 and `r data_inflation_beta$inflation_for_reporting[data_inflation_kernel$alpha == 0.90]`% more observations of Cronbach's $a$ = .90 than predicted.
