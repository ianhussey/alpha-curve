...
- Once we get access to it:
  - Do any necessary wrangling, including exclusion variables
  - Reorganise/rename data files/dirs  
  - Add descriptives
...
data_processed <- read_csv("../../data/processed/data_processed.csv")  # TODO Customise to I/O dataset

data_processed_trimmed <- data_processed |>
  filter(!is.na(alpha) & exclude_master == FALSE) # TODO Customise to I/O dataset
