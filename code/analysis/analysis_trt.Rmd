...
data_processed <- read_csv("../../data/processed/data_processed_trt.csv")

data_processed_trimmed <- data_processed |>
  filter(!is.na(alpha) & 
           exclude_master == FALSE &
           regex_label != "α") # excluded as they include many estimates other than alpha values
